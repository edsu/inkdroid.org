...
The first thing we do is <a href="http://purl.org/net/bagit">bag</a> up the content, to capture what was retrieved (manifest + checksums) and stash away some metadata about where it came from.
<pre lang="text">
adi_v2_i2
|-- bag-info.txt
|-- bagit.txt
