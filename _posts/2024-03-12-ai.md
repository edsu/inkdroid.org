...
**Tactic: When evaluating an AI tool always see if you can identify what data has been used to train a model, and how it has been "cleaned" or shaped in particular ways. How is it updated?**
